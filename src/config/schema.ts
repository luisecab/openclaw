...
const FIELD_LABELS: Record<string, string> = {
  ...
  "jobs.enabled": "Jobs Enabled",
  "jobs.schedule.time": "Jobs Schedule Time",
  "jobs.schedule.timezone": "Jobs Schedule Timezone",
  "jobs.query.keywords": "Job Keywords",
  "jobs.query.query": "Job Boolean Query",
  "jobs.query.locations": "Job Locations",
  "jobs.query.remotePreference": "Job Remote Preference",
  "jobs.query.seniority": "Job Seniority",
  "jobs.query.tags": "Job Tags",
  "jobs.providers": "Job Providers",
  "jobs.delivery.channel": "Jobs Delivery Channel",
  "jobs.delivery.target": "Jobs Delivery Target",
  "jobs.delivery.accountId": "Jobs Delivery Account",
  "jobs.dedupe.retentionDays": "Jobs Dedupe Retention (days)",
  "jobs.dedupe.maxEntries": "Jobs Dedupe Max Entries",
  "jobs.dedupe.storePath": "Jobs Dedupe Store Path",
...
const FIELD_HELP: Record<string, string> = {
  ...
  "jobs.enabled": "Enable daily job search digests.",
  "jobs.schedule.time": "Local time (HH:MM) for daily digest runs.",
  "jobs.schedule.timezone": "IANA timezone for the daily digest schedule.",
  "jobs.providers": "List of job feed providers (RSS/Greenhouse/Lever).",
  "jobs.delivery.channel": "Channel to send the job digest to.",
  "jobs.delivery.target": "Channel target for the digest (phone number, channel id, etc.).",
  "jobs.delivery.accountId": "Optional channel account id to use for delivery.",
  "jobs.dedupe.retentionDays": "How long to remember seen jobs before re-sending.",
  "jobs.dedupe.maxEntries": "Maximum number of seen jobs to keep on disk.",
  "jobs.dedupe.storePath": "Override path for the seen jobs store.",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "jobs.schedule.time": "08:30",
  "jobs.schedule.timezone": "Europe/Warsaw",
};
